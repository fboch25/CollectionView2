...
//  CollectionViewTESST
//
//  Created by Frank Joseph Boccia on 4/29/17.
...
class LoginViewController: UIViewController {
    ...
    let newViewController = ChatRoom()
    ...
    lazy var loginRegisterButton: UIButton = {
        ...
        button.backgroundColor = UIColor.green//(r: 80, g: 101, b: 161)
    ...
    func handleRegister() {
        ...
        FIRAuth.auth()?.createUser(withEmail: email, password: password, completion: { (user: FIRUser?, error) in
            ...
            if error != nil {
                print(error!)
                self.loginErrorAlert("Error!", message: "Incorrect Email or Password, please try again.")
                return
            }
            ...
            let ref = FIRDatabase.database().reference(fromURL: "https://gaming-hub-social-media.firebaseio.com")
    ...
    let profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "Green-HUB")
